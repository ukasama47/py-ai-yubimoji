...
static ::mlir::LogicalResult __mlir_ods_local_type_constraint_EmitC3(
    ::mlir::Operation *op, ::mlir::Type type, ::llvm::StringRef valueKind,
    unsigned valueIndex) {
  if (!(((emitc::isSupportedFloatType(type))) || (((emitc::isSupportedIntegerType(type))) || ((::llvm::isa<::mlir::IndexType>(type))) || ((::llvm::isa<::mlir::emitc::OpaqueType>(type)))))) {
    return op->emitOpError(valueKind) << " #" << valueIndex
        << " must be floating-point type supported by EmitC or integer type supported by EmitC or index or EmitC opaque type, but got " << type;
  }
  return ::mlir::success();
}
...
static ::mlir::LogicalResult __mlir_ods_local_type_constraint_EmitC4(
    ::mlir::Operation *op, ::mlir::Type type, ::llvm::StringRef valueKind,
    unsigned valueIndex) {
  if (!(((emitc::isSupportedIntegerType(type))) || ((::llvm::isa<::mlir::IndexType>(type))) || ((::llvm::isa<::mlir::emitc::OpaqueType>(type))))) {
    return op->emitOpError(valueKind) << " #" << valueIndex
        << " must be integer type supported by EmitC or index or EmitC opaque type, but got " << type;
  }
  return ::mlir::success();
}

static ::mlir::LogicalResult __mlir_ods_local_type_constraint_EmitC5(
    ::mlir::Operation *op, ::mlir::Type type, ::llvm::StringRef valueKind,
    unsigned valueIndex) {
...
static ::mlir::LogicalResult __mlir_ods_local_attr_constraint_EmitC9(
    ::mlir::Attribute attr, ::llvm::StringRef attrName, llvm::function_ref<::mlir::InFlightDiagnostic()> emitError) {
...
::mlir::LogicalResult BitwiseLeftShiftOpAdaptor::verify(::mlir::Location loc) {
  return ::mlir::success();
}
...
::mlir::LogicalResult BitwiseLeftShiftOp::verifyInvariantsImpl() {
  {
    unsigned index = 0; (void)index;
    auto valueGroup0 = getODSOperands(0);
...
::mlir::LogicalResult BitwiseLeftShiftOp::verifyInvariants() {
  return verifyInvariantsImpl();
}
...
::mlir::LogicalResult BitwiseRightShiftOpAdaptor::verify(::mlir::Location loc) {
  return ::mlir::success();
}
...
::mlir::LogicalResult BitwiseRightShiftOp::verifyInvariantsImpl() {
  {
    unsigned index = 0; (void)index;
    auto valueGroup0 = getODSOperands(0);
...
::mlir::LogicalResult BitwiseRightShiftOp::verifyInvariants() {
  return verifyInvariantsImpl();
}
...
::mlir::LogicalResult ConditionalOpAdaptor::verify(::mlir::Location loc) {
  return ::mlir::success();
}
...
::mlir::LogicalResult ConditionalOp::verifyInvariantsImpl() {
  {
    unsigned index = 0; (void)index;
    auto valueGroup0 = getODSOperands(0);
...
::mlir::LogicalResult ConditionalOp::verifyInvariants() {
  return verifyInvariantsImpl();
}
...
::mlir::LogicalResult GetGlobalOp::verifyInherentAttrs(::mlir::OperationName opName, ::mlir::NamedAttrList &attrs, llvm::function_ref<::mlir::InFlightDiagnostic()> emitError) {
    {
      ...
      if (attr && ::mlir::failed(__mlir_ods_local_attr_constraint_EmitC1(attr, "name", emitError)))
        return ::mlir::failure();
    }
    return ::mlir::success();
}
...
::mlir::LogicalResult GetGlobalOp::verifyInvariantsImpl() {
  ...
  if (::mlir::failed(__mlir_ods_local_attr_constraint_EmitC1(*this, tblgen_name, "name")))
    return ::mlir::failure();
  {
    unsigned index = 0; (void)index;
    auto valueGroup0 = getODSResults(0);
...
::mlir::LogicalResult GlobalOp::verifyInherentAttrs(::mlir::OperationName opName, ::mlir::NamedAttrList &attrs, llvm::function_ref<::mlir::InFlightDiagnostic()> emitError) {
    {
      ...
      if (attr && ::mlir::failed(__mlir_ods_local_attr_constraint_EmitC5(attr, "const_specifier", emitError)))
        return ::mlir::failure();
    }

    {
      ::mlir::Attribute attr = attrs.get(getExternSpecifierAttrName(opName));
      if (attr && ::mlir::failed(__mlir_ods_local_attr_constraint_EmitC5(attr, "extern_specifier", emitError)))
        return ::mlir::failure();
    }

    {
      ::mlir::Attribute attr = attrs.get(getInitialValueAttrName(opName));
      if (attr && ::mlir::failed(__mlir_ods_local_attr_constraint_EmitC4(attr, "initial_value", emitError)))
        return ::mlir::failure();
    }

    {
      ::mlir::Attribute attr = attrs.get(getStaticSpecifierAttrName(opName));
      if (attr && ::mlir::failed(__mlir_ods_local_attr_constraint_EmitC5(attr, "static_specifier", emitError)))
        return ::mlir::failure();
    }
...

    {
      ...
      if (attr && ::mlir::failed(__mlir_ods_local_attr_constraint_EmitC9(attr, "type", emitError)))
        return ::mlir::failure();
    }
    return ::mlir::success();
}
...
::mlir::LogicalResult GlobalOp::verifyInvariantsImpl() {
  ...
  if (::mlir::failed(__mlir_ods_local_attr_constraint_EmitC9(*this, tblgen_type, "type")))
    return ::mlir::failure();

  if (::mlir::failed(__mlir_ods_local_attr_constraint_EmitC4(*this, tblgen_initial_value, "initial_value")))
    return ::mlir::failure();

  if (::mlir::failed(__mlir_ods_local_attr_constraint_EmitC5(*this, tblgen_extern_specifier, "extern_specifier")))
    return ::mlir::failure();

  if (::mlir::failed(__mlir_ods_local_attr_constraint_EmitC5(*this, tblgen_static_specifier, "static_specifier")))
    return ::mlir::failure();

  if (::mlir::failed(__mlir_ods_local_attr_constraint_EmitC5(*this, tblgen_const_specifier, "const_specifier")))
    return ::mlir::failure();
  return ::mlir::success();
}
...
void GlobalOp::print(::mlir::OpAsmPrinter &_odsPrinter) {
  if (getExternSpecifierAttr()) {
    _odsPrinter << ' ' << "extern";
  }
  if (getStaticSpecifierAttr()) {
    _odsPrinter << ' ' << "static";
  }
  if (getConstSpecifierAttr()) {
    _odsPrinter << ' ' << "const";
  }
  _odsPrinter << ' ';
...
::mlir::LogicalResult SubscriptOpAdaptor::verify(::mlir::Location loc) {
  return ::mlir::success();
}
...
void SubscriptOp::build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, TypedValue<ArrayType> array, ValueRange indices) {
      build(odsBuilder, odsState, array.getType().getElementType(), array, indices);
    
}

void SubscriptOp::build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, TypedValue<PointerType> pointer, Value index) {
      build(odsBuilder, odsState, pointer.getType().getPointee(), pointer,
            ValueRange{index});
...
::mlir::LogicalResult SubscriptOp::verifyInvariantsImpl() {
  {
    unsigned index = 0; (void)index;
    auto valueGroup0 = getODSOperands(0);
...
::mlir::LogicalResult SubscriptOp::verifyInvariants() {
  if(::mlir::succeeded(verifyInvariantsImpl()) && ::mlir::succeeded(verify()))
    return ::mlir::success();
  return ::mlir::failure();
}
...
::mlir::LogicalResult UnaryMinusOpAdaptor::verify(::mlir::Location loc) {
  return ::mlir::success();
}
...
::mlir::LogicalResult UnaryMinusOp::verifyInvariantsImpl() {
  {
    unsigned index = 0; (void)index;
    auto valueGroup0 = getODSOperands(0);
...
::mlir::LogicalResult UnaryMinusOp::verifyInvariants() {
  return verifyInvariantsImpl();
}
...
::mlir::LogicalResult UnaryPlusOpAdaptor::verify(::mlir::Location loc) {
  return ::mlir::success();
}
...
::mlir::LogicalResult UnaryPlusOp::verifyInvariantsImpl() {
  {
    unsigned index = 0; (void)index;
    auto valueGroup0 = getODSOperands(0);
...
::mlir::LogicalResult UnaryPlusOp::verifyInvariants() {
  return verifyInvariantsImpl();
}
