...
#     files = glob.glob(os.path.join(img_dir, '*.jpg')) + glob.glob(os.path.join(img_dir, '*.jpeg')) + glob.glob(os.path.join(img_dir, '*.JPG')) + glob.glob(os.path.join(img_dir, '*.JPEG'))
...
for idx, category in enumerate(CATEGORIES):
    ...
    files = glob.glob(os.path.join(img_dir, '*.JPG')) + glob.glob(os.path.join(img_dir, '*.jpg'))
